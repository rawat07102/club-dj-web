...
import QueueCard from "../clubs/[clubId]/playlists/[playlistId]/player/queue-card"
                ...
                <div className="flex flex-col bg-secondary w-full max-w-sm">
                    ...
                    <div>
                        <Button onClick={() => voteSkip(clubId)}>
                            Vote Skip{" "}
                            {playerPayload && playerPayload.voteSkipCount}
                        </Button>
                        <div>
                            <Label>Add Video to Queue</Label>
                            <Input
                                value={addVideoId}
                            ...
                            <Button
                                onClick={() =>
                                    addVideoToQueue(club.id, addVideoId)
                                }
                            >
                                Add to Queue
                            </Button>
                            <Button
                                onClick={() => {
                                    window.player.loadVideoById("qR2QIJdtgiU")
                                }}
                            >
                                Load new Video
                            </Button>
